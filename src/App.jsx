...
const AdminDashboard = lazy(() => retryLazy(() => import('./pages/admin/Dashboard')));
const AdminSettings = lazy(() => retryLazy(() => import('./pages/admin/Settings')));
const AdminClasses = lazy(() => retryLazy(() => import('./pages/admin/Classes')));
const AdminStudents = lazy(() => retryLazy(() => import('./pages/admin/Students')));
const AdminStudentForm = lazy(() => retryLazy(() => import('./pages/admin/StudentForm')));
const AdminStudentProfile = lazy(() => retryLazy(() => import('./pages/admin/StudentProfile')));
const AdminSubjects = lazy(() => retryLazy(() => import('./pages/admin/Subjects')));
const AdminResults = lazy(() => retryLazy(() => import('./pages/admin/Results')));
const AdminPromotion = lazy(() => retryLazy(() => import('./pages/admin/Promotion')));
const AdminTranscript = lazy(() => retryLazy(() => import('./pages/admin/Transcript')));
const TeacherDashboard = lazy(() => retryLazy(() => import('./pages/teacher/Dashboard')));
const TeacherMyStudents = lazy(() => retryLazy(() => import('./pages/teacher/MyStudents')));
const TeacherMyResults = lazy(() => retryLazy(() => import('./pages/teacher/MyResults')));
const TeacherMyAttendance = lazy(() => retryLazy(() => import('./pages/teacher/MyAttendance')));
const StudentDashboard = lazy(() => retryLazy(() => import('./pages/student/Dashboard')));
const StudentMyResults = lazy(() => retryLazy(() => import('./pages/student/MyResults')));
const StudentMyAttendance = lazy(() => retryLazy(() => import('./pages/student/MyAttendance')));
const BackupPage = lazy(() => retryLazy(() => import('./pages/admin/Backup')));
const ReportsPage = lazy(() => retryLazy(() => import('./pages/admin/Reports')));
const UsersPage = lazy(() => retryLazy(() => import('./pages/admin/Users')));
const AttendancePage = lazy(() => retryLazy(() => import('./pages/admin/Attendance')));
const AttendanceReportPage = lazy(() => retryLazy(() => import('./pages/admin/AttendanceReport')));
const ParentDashboard = lazy(() => retryLazy(() => import('./pages/parent/Dashboard')));
const ParentChildrenResults = lazy(() => retryLazy(() => import('./pages/parent/ChildrenResults')));
const ParentChildrenAttendance = lazy(() => retryLazy(() => import('./pages/parent/ChildrenAttendance')));
const NotFound = lazy(() => retryLazy(() => import('./pages/NotFound')));
const AuditLogPage = lazy(() => retryLazy(() => import('./pages/admin/AuditLog')));
