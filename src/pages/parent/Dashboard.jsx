...
import {
  BookOpen, Users, Award, BarChart3, Clock, Bell, LogOut, Menu,
  GraduationCap, TrendingUp, FileText, School, User, Hash, Calendar,
  Download, Eye, CheckCircle, XCircle, AlertCircle, UserCheck, Moon, Sun
} from 'lucide-react';
...
export default function ParentDashboard() {
  ...
  const statusIcon = (status) => {
    if (status === 'present') return <CheckCircle className="w-4 h-4 text-emerald-500" />;
                          ...
                          <table className="w-full text-sm">
                            <thead>
                              <tr className="bg-muted/50 border-b border-border">
                                ...
                                <th className="text-center px-3 py-2 text-xs font-semibold text-muted-foreground uppercase">Sem</th>
